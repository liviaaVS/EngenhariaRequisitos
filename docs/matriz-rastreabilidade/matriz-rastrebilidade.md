...
* **FE3 – Análise de Concorrentes**
* **FE4 – Regras de Negócio**
* **FE5 – Necessidades dos Usuários**
* **FE6 – Brainstorming da Equipe (Livia, danilo, Jesse, Marília)**
* **FE7 – ISO/IEC 25010:2023 (Modelo de Qualidade de Produto)**
* **FE8 – Conteúdo da disciplina de Engenharia de Requisitos**
...
| RF04      | Upload de mídias                |  X  |  X  |  X  |  X  |  X  |     |
| RF05      | Gestão de catálogo              |  X  |  X  |  X  |     |  X  |     |
...
| RF13      | Relatórios de vendas            |  X  |  X  |     |     |     |  X  |
...
| NF04      | Disponibilidade                |  X  |     |  X  |     |     |     |  X  |  X  |
| NF05      | Desempenho                     |  X  |     |  X  |     |     |     |  X  |  X  |
| NF06      | Escalabilidade                 |  X  |     |  X  |     |     |     |  X  |  X  |



| Para detalhar os requisitos clique [aqui](/visao/doc-visao.md)